...
public record GameSdkConfig(int maxGames, int minPlayers, @NotNull Function<GameCreationInfo, ? extends Game> gameCreator) {
    ...
    public static final class Builder {
        ...
        public @NotNull GameSdkConfig build() {
            if (this.maxGames == -1) {
                throw new IllegalStateException("maxGames must be set");
            }
            if (this.gameSupplier == null) {
                throw new IllegalStateException("gameCreator must be set");
            }
